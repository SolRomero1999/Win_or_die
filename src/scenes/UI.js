...
export default class UI extends Phaser.Scene {
  ...
  crearContadoresMonedas() {
    ...
    const btnWAD = this.add.image(-background.width + (background.width * 0.75), -35, "wasd").setOrigin(0.5).setScale(0.6);
    const btnFlechas = this.add.image(background.width - (background.width * 0.75), -35, "flechas").setOrigin(0.5).setScale(0.6);
